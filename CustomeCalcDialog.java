...
public class CustomeCalcDialog extends DialogFragment {

    private static final String TAG = CustomeCalcDialog.class.getSimpleName();
    ...
    Dialog onCreateDialog(Bundle state) {
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.activity_custome_calc_dialog, null);
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setValue(@Nullable BigDecimal value) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setMaxValue(@Nullable BigDecimal maxValue) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setMaxDigits(int intPart, int fracPart) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setRoundingMode(RoundingMode roundingMode) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setStripTrailingZeroes(boolean strip) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setSignCanBeChanged(boolean canBeChanged, int sign) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setFormatSymbols(char decimalSep, char groupSep) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setClearDisplayOnOperation(boolean clear) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setShowZeroWhenNoValue(boolean show) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setGroupSize(int size) {
        if (size < 0) {
     ...
     * @return the dialog
     */
    public CustomeCalcDialog setShowAnswerButton(boolean show) {
        showAnswerBtn = show;
    ...
    public void onAttach(Context context) {
        ...
        ta.recycle();
        this.context = new android.view.ContextThemeWrapper(context, style);
    }
